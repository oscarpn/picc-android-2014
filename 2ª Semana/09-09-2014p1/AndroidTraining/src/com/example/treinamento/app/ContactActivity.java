...
public class ContactActivity extends LifeCycleActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (contact == null) {
			contact = new Contact();
			subtitleResource = R.string.subtitle_add_contact;
		} else {
			loadContactOnScreen();
			subtitleResource = R.string.subtitle_edit_contact;
		}
		getSupportActionBar().setSubtitle(subtitleResource);
		...
		btnSaveContact.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				try {
					ContactService.getInstance(ContactActivity.this).saveContact(contact);
