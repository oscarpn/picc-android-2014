...
public final class ContatoEntity {
    ...
    public static final String CREATE = "CREATE TABLE " + TABELA + 
							    		"(" +
								    		...
								    		COLUNA_FOTO + "TEXT NOT NULL," +  
								    		COLUNA_RELEVANCIA + " REAL" +
							    		");";

    public static final String DROP = "DROP TABLE IF EXISTS " + TABELA + ";";
    
    public static final String[] COLUNAS = { COLUNA_ID, COLUNA_NOME, COLUNA_ENDERECO, COLUNA_SITE, COLUNA_TELEFONE, COLUNA_FOTO, COLUNA_RELEVANCIA };
	...
	public static Contato bindContato(Cursor cursor) {
		if (!cursor.isBeforeFirst() || cursor.moveToNext()) {
			...
			contato.setFoto(cursor.getString(cursor.getColumnIndex(COLUNA_FOTO)));
